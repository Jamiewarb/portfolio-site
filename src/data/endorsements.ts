...
export const endorsements: Endorsement[] = [
  {
    ...
    paragraphs: [
      ...
      'He is dedicated to quality and consistently goes above and beyond to deliver fantastic solutions for clients. One of his greatest strengths is bridging the gap between the technical and the non-technical; he ensures complex explanations never bamboozle people, whether he\u2019s translating things for me internally or guiding clients through a project. Over the best part of the last decade, <strong>Jamie has been my ultimate \u2018technical bestie,\u2019 and I have zero hesitation in recommending him to be yours.</strong>',
    ],
  },
  {
    name: 'Dip Jhutti',
